...
<header class="panel-cover"
        style="background-image: url(<?php echo get_bloginfo('template_url') ?>/static/images/404/bg.jpg)">
    ...
    <div class="panel-main">
        ...
        <div class="panel-main__inner panel-inverted">
            <div class="panel-main__content">
                ...
                <a href="<?php echo get_bloginfo("siteurl"); ?>"><img
                            src="<?php echo get_bloginfo('template_url') ?>/static/images/404/few.jpg" width="150"
                            alt="Noisky logo"
                            class="panel-cover__logo logo"></a>
                <h1 class="panel-cover__title panel-title"><a href="http://www.yanwz.cn/"
                                                              title="link to homepage for noisky">404</a></h1>
